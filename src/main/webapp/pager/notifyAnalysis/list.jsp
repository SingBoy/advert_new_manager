...
<body>
	...
	<div class="page-breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/notifyAnalysis/list">按广告查询</a></li>
		</ul>
	</div>
	<!-- Page Header -->
			...
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						<form id="analysisAdvertisers_form" action="${pageContext.request.contextPath}/notifyAnalysis/list" method="post" class="form-inline" role="form">
							<div class="row">
								<div class="col-lg-12 col-sm-12 col-xs-12">
									...
									<div class="form-group">
										<select id="resourcesName" name="resourcesName" class="multiselect" style="width: 210px;">
							...
							<table class="table table-hover table-bordered table-striped table-condensed flip-content">
								<thead class="flip-content bordered-palegreen">
									<tr>
										...
										<th class="text-center" style="width:150px;">访问数量</th>
										<th class="text-center" style="width:150px;">订阅数量</th>
								...
								<tbody>
									<c:forEach items="${pageDataList.pageRecords}" var="item">
										<tr>
											...
											<td class="text-center" style="word-break:break-all;">${item.advertisersname }</td>
						...
						<div class="footer">
							<!-- 分页  -->
							<c:url var="pageUrl" value="/notifyAnalysis/list">
								<c:param name="startDate" value="${queryBean.startDate}" />
								<c:param name="endDate" value="${queryBean.endDate}" />
								<c:param name="advertisersName" value="${queryBean.advertisersName}" />
								<c:param name="resourcesName" value="${queryBean.resourcesName}" />
							</c:url>
			...
			if(startDate != "" && endDate !=""){
			    ...
			    if(start > d || end > d){
				    ...
				    if(end<start){
				    	...
				    	$("#analysisAdvertisers_form").submit();
				    }
			    }
			}
		});
