...
<body>
	...
	<div class="page-breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/offerStatistics/list">按广告查询</a></li>
		</ul>
	</div>
	<!-- Page Header -->
			...
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						<form id="offerStatistics_form" action="${pageContext.request.contextPath}/offerStatistics/list" method="post" class="form-inline" role="form">
							<div class="row">
						...
						<div class="footer">
							<!-- 分页  -->
							<c:url var="pageUrl" value="/offerStatistics/list">
