...
<body>
	...
	<div class="page-breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/trafficSourceStatistics/list">按渠道查询</a></li>
		</ul>
	</div>
	<!-- Page Header -->
...
<!-- 		</div> -->
		...
		<div class="header-buttons">
			...
			</a> <a class="refresh" id="refresh-toggler" href="${pageContext.request.contextPath}/trafficSourceStatistics/list"> <i class="glyphicon glyphicon-refresh"></i>
			...
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						<form id="trafficSourceStatistics_form" action="${pageContext.request.contextPath}/trafficSourceStatistics/list" method="post" class="form-inline" role="form">
							<div class="row">
			...
			if(startDate != "" && endDate !=""){
			    ...
			    if(start > d || end > d){
				    ...
				    if(end<start){
				    	...
				    	$("#trafficSourceStatistics_form").submit();
				    }
			    }
			}
		});
