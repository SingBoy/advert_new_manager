...
<!-- 		</div> -->
		...
		<div class="header-buttons">
			...
			</a> <a class="refresh" id="refresh-toggler" href="${pageContext.request.contextPath}/twoPromotion/list?pid=${queryBean.pid}"> <i class="glyphicon glyphicon-refresh"></i>
					...
					<div class="widget-body">
						<div class="row">
							<div class="col-lg-12 col-sm-12 col-xs-12">
								...
								<a type="button" class="btn btn-primary" href="${pageContext.request.contextPath}/twoPromotion/save?pid=${queryBean.pid}&currentPage=${queryBean.currentPage}&pageSize=${queryBean.pageSize}">链接生成</a>
							</div>
						</div>
						<br />
						...
						<div class="footer">
							<!-- 分页  -->
							<c:url var="pageUrl" value="/twoPromotion/list">
	...
	<script type="text/javascript">
		...
		function confirmImg(id) {
			if (confirm("你确认要删除吗？")){
				window.location = "${pageContext.request.contextPath}/twoPromotion/delete/"+id
