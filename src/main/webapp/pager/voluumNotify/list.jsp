...
<body>
	...
	<div class="page-breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/voluum/list">数据查询</a></li>
		</ul>
	</div>
	<!-- Page Header -->
	<div class="page-header position-relative">
		<div class="header-buttons">
			...
			</a> <a class="refresh" id="refresh-toggler" href="${pageContext.request.contextPath}/voluum/list"> <i class="glyphicon glyphicon-refresh"></i>
			...
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						<form action="${pageContext.request.contextPath}/voluum/list" method="post" class="form-inline" role="form">
							<div class="row">
						...
						<div class="footer">
							<!-- 分页  -->
							<c:url var="pageUrl" value="/voluum/list">
	...
	<script type="text/javascript">
		...
		function confirmImg(id) {
			if (confirm("你确认要删除吗？")){
				window.location = "${pageContext.request.contextPath}/voluum/delete/"+id +
