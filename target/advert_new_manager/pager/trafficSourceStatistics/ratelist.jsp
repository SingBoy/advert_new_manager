...
<!-- 		</div> -->
		...
		<div class="header-buttons">
			...
			</a> <a class="refresh" id="refresh-toggler" href="${pageContext.request.contextPath}/trafficSourceStatistics/rateList"> <i class="glyphicon glyphicon-refresh"></i>
			...
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						<form id="trafficSourceStatistics_form" action="${pageContext.request.contextPath}/trafficSourceStatistics/rateList" method="post" class="form-inline" role="form">
							<div class="row">
						...
						<div class="footer">
							<!-- 分页  -->
							<c:url var="pageUrl" value="/trafficSourceStatistics/rateList">
